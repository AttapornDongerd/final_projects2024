                                            ...
                                            <div class="card shadow-sm">
                                                ...
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="col-xl-9"><?= $order_sewingInfo['period']; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="col-xl-4 text-muted text-center"> วันที่สั่งตัด </th>
                                                            <td class="col-xl-9"><?= $order_sewingInfo['ord_date']; ?></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th class="col-xl-4 text-muted text-center">สถานะ :</th>
                                                            <td class="col-xl-9">
                                                                <?php
                                                                $ord_status_check = $order_sewingInfo['ord_status_check'];
                                                                if ($ord_status_check === 1) {
                                                                    echo '<span class="badge badge-info">กำลังตัด</span>';
                                                                } else if ($ord_status_check === 2) {
                                                                    echo '<span class="badge badge-success">เสร็จสิ้น</span>';
                                                                } else if ($ord_status_check === 3) {
                                                                    echo '<span class="badge badge-secondary">กำลังแก้</span>';
                                                                } else {
                                                                    echo $ord_status_check;
                                                                }
                                                                ?>
                                                            </td>
                                                        </tr>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-4 text-center">
                                                        <form id="formData">
                                                            <label for="statuschecked">เลือกสถานะ</label>
                                                            <select id="ord_status_check" class="form-control"> require
                                                                <option value=0>-</option>
                                                                <!-- <option value=1>กำลังตัด</option> -->
                                                                <option value=2>เสร็จสิ้น</option>
                                                                <!-- <option value=3>เสร็จสิ้น</option>
                                                                <option value=4>นัดรับ</option> -->
                                                            </select>
                                                            <br><br>

                                                            <button class="btn btn-success" type="submit" value="Submit">
                                                                <i class="fas fa-check"></i>
                                                                ยืนยันการตัดชุดเสร็จสิ้น
                                                            </button>

                                                            <input type="hidden" id="ord_id" name="ord_id" value="<?= $order_sewingInfo['ord_id']; ?>">
                                                            </input>
                                                        </form>
                                                    </div>
                                                    <div class="col-4 text-center"></div>
        ...
        <script>
            $(function() {
                $('#formData').submit(function(e) {
                    ...
                    $.ajax({
                        type: 'PUT',
                        url: '../../service/queu_e/update_status.php',
